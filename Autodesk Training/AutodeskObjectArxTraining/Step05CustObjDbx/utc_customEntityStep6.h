...
//-----------------------------------------------------------------------------
//----- utc_customEntityStep6.h : Declaration of the utc_customEntityStep6
//-----------------------------------------------------------------------------
#pragma once
...
//-----------------------------------------------------------------------------
class DLLIMPEXP utc_customEntityStep6 : public AcDbEllipse {

public:
	ACRX_DECLARE_MEMBERS(utc_customEntityStep6) ;

protected:
	static Adesk::UInt32 kCurrentVersionNumber ;

public:
	utc_customEntityStep6 () ;
	virtual ~utc_customEntityStep6 () ;
...
#ifdef STEP05CUSTOBJDBX_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(utc_customEntityStep6)
#endif


#define UTC_CUSTOMENTITYSTEP6_DBXSERVICE _T("UTC_CUSTOMENTITYSTEP6_DBXSERVICE")