...
//-----------------------------------------------------------------------------
//----- utc_EmployeeDetails.h : Declaration of the utc_EmployeeDetails
//-----------------------------------------------------------------------------
#pragma once
...
//-----------------------------------------------------------------------------
class DLLIMPEXP utc_EmployeeDetails : public AcDbObject {
...
public:
	ACRX_DECLARE_MEMBERS(utc_EmployeeDetails) ;
...
#ifdef STEP05CUSTOBJDBX_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(utc_EmployeeDetails)
#endif
