...
//-----------------------------------------------------------------------------
//----- UTC_EmployeeDB.h : Declaration of the UTC_EmployeeDB
//-----------------------------------------------------------------------------
#pragma once

#ifdef STEP06CUSTOMENTITYDBX_MODULE
...
//-----------------------------------------------------------------------------
class DLLIMPEXP UTC_EmployeeDB : public AcDbObject {

public:
	ACRX_DECLARE_MEMBERS(UTC_EmployeeDB) ;
...
#ifdef STEP06CUSTOMENTITYDBX_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(UTC_EmployeeDB)
#endif

#define UTCEMPLOYEEDB_DBXSERVICE _T("UTCEMPLOYEEDB_DBXSERVICE")
