...
//AC_DECLARE_EXTENSION_MODULE(ArxProject1DLL) ;
...
public:
	...
	virtual AcRx::AppRetCode On_kInitAppMsg(void* pkt) {
		...
		//ArxProject1DLL.AttachInstance (_hdllInstance) ;
		//InitAcUiDLL () ;
	...
	virtual AcRx::AppRetCode On_kPreQuitMsg(void* pkt) {
		...
		// You *must* call On_kUnloadAppMsg here
		AcRx::AppRetCode retCode = AcRxArxApp::On_kPreQuitMsg(pkt);
		return (retCode);
	}
